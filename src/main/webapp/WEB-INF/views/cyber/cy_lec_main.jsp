				...
				<div class="cen_middle">
					...
					<div align="center" style="min-height: 50%; ">
						...
						<div class="left_div" style="width: 80%; min-height: 40%;">
							<h1 style="text-align: left;max-width: 70%;">공지사항</h1>
							<br>
							<table class="st_mint">
								<thead>
									<tr>
										...
										<c:forEach var="vo" items="${dtos}">
											<tr>
												...
												<td><a style="color: black;"
													href="cy_lec_notice_form?num=${vo.cy_lec_n_no}&pageNum=${pageNum}&lec_no=${lec_no}">
														${vo.cy_lec_n_title} </a></td>
								...
								<tr>
									<th align="center"><c:if test="${cnt>0}">
											...
											<c:if test="${startPage > pageBlock}">
												...
												<a
													href="cy_lec_main?lec_no=${lec_no}&pageNum=${startPage-pageBlock}">&nbsp;◀</a>
											</c:if>
							...
							<c:if
								...
								<input class="btn_mint" type="button" value="글 작성"
									onclick="window.location='cy_lec_notice_write_form?lec_no=${lec_no}'">
							</c:if>
						</div>
					</div>
				</div>
